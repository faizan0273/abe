...
class communitiesPage extends StatefulWidget {
  ...
  @override
  _communitiesPageScreenState createState() => _communitiesPageScreenState();
}

class _communitiesPageScreenState extends State<communitiesPage> {
                                ...
                                Expanded(
                                    child: Row(
                                      children: [
                                        ...
                                        SizedBox(width: 10,),
                                        Text("Communities",style: TextStyle(fontSize: 16,fontFamily: 'Gilroy',fontWeight: FontWeight.bold),)
                                      ],
                                    )
                                ),
                                Expanded(
