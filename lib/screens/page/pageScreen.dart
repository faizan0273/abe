...
class _pageScreenState extends State<page> {
                ...
                children: [
                              ...
                              child:Column(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      SizedBox(width: 27,),
                                      Text("McDonalds",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,fontFamily: 'Gilroy'),),
                                    ],
                                  ),
                                  SizedBox(height: 15,),
                                  Row(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          Text("Followers   |",style: TextStyle(fontFamily: 'Gilroy'),),
                                          Text("10.7M   ",style: TextStyle(fontFamily: 'Gilroy'),),
                                        ],
                                      ),
                                      Column(
                                        mainAxisAlignment: MainAxisAlignment.start,
                                        children: [
                                          Text("   Following",style: TextStyle(fontFamily: 'Gilroy'),),
                                          Text("   554",style: TextStyle(fontFamily: 'Gilroy'),),
                                        ],
                                      ),
                                    ],
                                  )
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 5,),
                      Text("McDonald's Corporation is an American-based multinational fast food chain, founded in 1940 as a restaurant operated by Richard and Maurice McDonald, in San Bernardino, California, United States",style: TextStyle(fontSize: 10,fontFamily: 'Gilroy'),),
                    ],
                  ),
                  SizedBox(height: 8,),
                  TextField(
