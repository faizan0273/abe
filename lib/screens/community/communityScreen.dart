              ...
              Row(
                children: [
                  ...
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Text("Communities",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,fontFamily: 'Gilroy'),)
                    ],
                  ),
                ],
              ),
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: SvgPicture.asset("assets/community.svg",width: 30,height: 20,fit: BoxFit.none,),
                    ),
                    SizedBox(width: 5,),
                    Flexible(
                      child: Container(
